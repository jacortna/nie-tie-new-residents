      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-3">
              ...
              <span className="font-heading font-bold text-primary">ResiGuía</span>
            </Link>
        ...
        <div className="border-t border-border/50 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} ResiGuía. Información orientativa, no constituye asesoramiento legal.
          </p>
          <p className="text-xs text-muted-foreground">
